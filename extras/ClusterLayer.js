define([
  ...
  SpatialReference, aPoint, Graphic, SimpleMarkerSymbol, TextSymbol,Font,
  PopupTemplate, GraphicsLayer
    ...
    return declare([GraphicsLayer], {
        ...
        add: function (p) {
            ...
            //map.infoWindow.setTitle("<br />" + map.infoWindow._title.innerText);
        },
        ...
        onClick: function (e) {
           ...
           // alert(111);
            ...
            if (singles.length > this._maxSingles) {
                ...
                if (this.id.toLowerCase() == 'completed')
                {
                    //alert('open completed in panel for country: ' + singles[0].attributes.Country)

                    populatePanelByCountry(singles[0].attributes.Country);
                    $('h3.completed')[0].click();
                    //$('.esriPopup .titlePane').css('background-color', '#008FE3');
                    //$('.esriPopup .titlePane').css('border', '1px solid #008FE3');
                    //$('.esriPopup .actionsPane .action').css('color', '#008FE3');
                }
                else if (this.id.toLowerCase() == 'planned') {
                    populatePanelByCountry(singles[0].attributes.Country);
                    $('h3.planned')[0].click();
                    //$('.esriPopup .titlePane').css('background-color', '#8D529D');
                    //$('.esriPopup .titlePane').css('border', '1px solid #8D529D');
                    //$('.esriPopup .actionsPane .action').css('color', '#8D529D');
                }
                else if (this.id.toLowerCase() == 'inprogress') {
                    populatePanelByCountry(singles[0].attributes.Country);
                    $('h3.inprogress')[0].click();
                    //$('.esriPopup .titlePane').css('background-color', '#8D529D');
                    //$('.esriPopup .titlePane').css('border', '1px solid #8D529D');
                    //$('.esriPopup .actionsPane .action').css('color', '#8D529D');
                }
        ...
        _showCluster: function (c) {
            var point = new aPoint(c.x, c.y, this._sr);
            this.add(
              new Graphic(
                point,
                null,
          ...
          /*  if (c.attributes.clusterCount == 1) {
            ...
            */
            ...
            font.setSize("16pt");
            font.setFamily("'Open Sans', Helvetica, sans-serif");
